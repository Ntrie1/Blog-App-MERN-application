        ...
        <div className='p-3 max-w-3xl mx-auto min-h-screen'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                <div className='flex flex-col gap-4 sm:flex-row justify-between'>
                    <TextInput type='text' placeholder='Title' required id='title' className='flex-1' value={formData.title} onChange={(e) => setFromData({ ...formData, title: e.target.value })} />
                ...
                <ReactQuill value={formData.content} theme='snow' placeholder='Write something...' className='h-72 mb-12' required onChange={(value) => setFromData({ ...formData, content: value })} />
